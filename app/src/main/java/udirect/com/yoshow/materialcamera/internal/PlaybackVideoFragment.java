...
import udirect.com.yoshow.easyvideoplayer.EasyVideoCallback;
import udirect.com.yoshow.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(udirect.com.yoshow.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(udirect.com.yoshow.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(udirect.com.yoshow.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
