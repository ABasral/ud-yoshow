...
import udirect.com.yoshow.materialcamera.util.Degrees;
import udirect.com.yoshow.materialcamera.util.ImageUtil;
import udirect.com.yoshow.materialcamera.util.ManufacturerUtil;

import static udirect.com.yoshow.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static udirect.com.yoshow.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static udirect.com.yoshow.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  udirect.com.yoshow.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new udirect.com.yoshow.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof udirect.com.yoshow.materialcamera.internal.CameraPreview)
